...
@Console(description = "Controller to manage the cronjobs in console.", name = "Cronjobs", version = 1)
@Route(route = "/cronjobs")
@CORS
public class CronjobsConsole extends ControllerCore{
	@GET
	public static void getCronjobs(HttpRequest req, HttpResponse res){
