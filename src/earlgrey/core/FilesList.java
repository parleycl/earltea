...
public class FilesList {
	...
	// Console Files
	public static FilePackage Console = new FilePackage("earlgrey.admin", new String[]{"CacheConsole", "LogsConsole", "PropertiesManager", "UserConsole", "Datasources", "RoutesConsole", 
			"ControllersConsole", "ModelsConsole", "CronjobsConsole", "ConfigsConsole", "ClusterConsole"});
	// Anotations Files
