...
import geos.annotations.AddPropertie;
import geos.annotations.AddPropertieArray;
import geos.annotations.AddPropertieOption;
import geos.annotations.AddPropertieSet;
import geos.annotations.Console;
import geos.annotations.Controller;
import geos.annotations.ControllerAction;
import geos.annotations.DatabaseDriver;
...
import geos.database.Connector;
import geos.def.ErrorDef;
import geos.def.ModelRest;
import geos.def.RouteDef;
import geos.error.Error500;
import geos.error.ErrorBase;
...
public class ResourceMaping {
	...
	public static synchronized ResourceMaping getInstance(){
		if(instance == null) instance = new ResourceMaping();
		return instance;
	}
	//CONSTRUCTOR
